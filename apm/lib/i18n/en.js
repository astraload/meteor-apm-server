...
strings.share = {
  ...
  collaborator_invite_email_tmpl:
    "Hello, <br/><br> Congratulations! You now have access to <b><%= appName %></b> on Kadira. <br> Please <a href='<%= inviteUrl %>'>Visit Kadira</a> to begin.",
  new_collaborator_invite_email_tmpl:
    "Hello, <br/><br> Congratulations! You now have access to <b><%= appName %></b> on Kadira. <br> Please <a href='<%= inviteUrl %>'>Visit Kadira</a> to begin.<br>It seems you are new to Kadira, you can log in using your email and <%= invitePass %> as a password. You can change your password after the first logon!<br><br>Thank You!",
  ...
  notify_for_new_owner_email_templ: 
    "Hello, <br/><br> Congratulations! You are invited to become the owner of application <a href='<%= appLink %>'><%= appName %></a> on Kadira. Click <a href='<%= inviteUrl %>'> here </a> to accept invitation.<br>If you are new to Kadira, you can log in using your email and <%= invitePass %> as a password. You can change your password after the first logon!<br><br>Thank You!",
